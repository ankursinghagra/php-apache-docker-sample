...
<li><a href="<?=base_url()?>admin/dashboard"><i class="fa fa-home"></i> Dashboard</a></li>
			...
			<div class="row">
					...
					<div class="col-md-8 col-md-offset-2">
						<form method="post" id="videos_form" class="form">
							...
							<div class="form-group">
								...
								<input type="text" name="video_hash" id="video_hash" class="form-control">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="submit" value="SAVE" class="btn btn-primary" id="form_submit">
							</div>
						</form>
					</div>
				</div>
				<div class="col-md-4">
					...
					<div class="hidden">
						<h3 id="video_title_span">Title</h3>
						<p id="video_description_span">Description</p>
					</div>
				</div>
			</div>
