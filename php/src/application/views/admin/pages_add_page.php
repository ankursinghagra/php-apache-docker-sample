	<div class="page-content">
		<div class="container-fluid">
			<header class="section-header">
	          ...
	          <li class="active"><a href="#"><i class="fa fa-list-ul"></i> Add Page</a></li>
							</ol>
						</div>
					</div>
				</div>
					...
					<form action="" method="post" class="form">
						<div class="col-md-12">
							...
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" name="page_title" value="<?=set_value('page_title')?>">
							</div>
							<div class="form-group col-md-6">
								<label>Page Subtitle</label>
								<input type="text" class="form-control" name="page_subtitle" value="<?=set_value('page_subtitle')?>">
							</div>
							<div class="form-group col-md-6">
								<label>Page Slug</label>
								<input type="text" class="form-control" name="page_slug" value="<?=set_value('page_slug')?>">
							</div>
						</div>
						...
						<div class="col-md-12" style="padding: 15px;margin: 10px auto;background-color:#ececec;border-radius:1px;">
							...
							<div class="form-group col-md-6">
								...
								<textarea class="form-control" name="meta_keywords" rows="4"></textarea>
							</div>
							<div class="form-group col-md-6">
