	<div class="page-content">
		<div class="container-fluid">
						...
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								<li><a href="<?=base_url()?>admin/dashboard"><i class="fa fa-home"></i> Dashboard</a></li>
	          					...
	          					<li class="active"><a href="#"><i class="fa fa-list-ul"></i> Edit Project</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
				<h5 class="m-t-lg with-border">Edit Project (Project Slug = <?=$form_data_sql['project_title']?>)</h5>
				...
				<div class="row">
					...
					<div class="col-md-12"><a href="<?=base_url()?>admin/projects/photos/<?=$form_data_sql['id']?>" class="btn btn-success">Photos</a></div>
				</div>
