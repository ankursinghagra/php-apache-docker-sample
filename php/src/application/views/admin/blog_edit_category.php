						...
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								<li><a href="<?=base_url()?>admin/dashboard"><i class="fa fa-home"></i> Dashboard</a></li>
					          	...
					          	<li><a href="<?=base_url()?>admin/blog/blog_category"><i class="fa fa-list-ul"></i> All Blog Categories</a></li>
					          	<li class="active"><a href="#"><i class="fa fa-list-ul"></i> Edit Blog Category</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<?php }else{ ?>
						<img src="<?=base_url()?>uploads/blog/<?=$page_data['blog_category_image']?>" style="max-width:200px;" class="img-responsive">
						<br><h3 class="label label-primary">Photo Selected</h3>
						<?php } ?>
					</div>
					<div class="col-md-12">
					...
					<div class="col-md-12">
						<form action="" method="post"class="form">
							<div class="form-group col-md-12">
								...
								<input type="text" class="form-control" name="blog_category_title" value="<?=$page_data['blog_category_title']?>">
							</div>
							<div class="form-group col-md-12">
								<label>Blog Category Slug : <b><?=$page_data['blog_category_slug']?></b></label>
							</div>
							<div class="form-group col-md-12">
								<label>Blog Category Description</label>
								<textarea class="editor" name="blog_category_description" rows="30"><?=$page_data['blog_category_description']?></textarea>
							</div>
							<div class="col-md-12" style="padding: 15px;margin: 10px auto;background-color:#ececec;border-radius:1px;">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" name="blog_category_seo_title" value="<?=$page_data['blog_category_seo_title']?>">
								</div>
								<div class="form-group col-md-12">
									<label>Blog Category Seo Keywords</label>
									<input type="text" class="form-control" name="blog_category_seo_keywords" value="<?=$page_data['blog_category_seo_keywords']?>">
								</div>
								<div class="form-group col-md-12">
									<label>Blog Category Seo Description</label>
									<textarea class="form-control" name="blog_category_seo_description" rows="5"><?=$page_data['blog_category_seo_description']?></textarea>
								</div>
							</div>
							<?php if(isset($blog_photo_uploaded)) { ?>
