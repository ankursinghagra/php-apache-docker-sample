						...
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								<li><a href="<?=base_url()?>admin/dashboard"><i class="fa fa-home"></i> Dashboard</a></li>
					          	...
					          	<li class="active"><a href="#"><i class="fa fa-list-ul"></i> Add Blog</a></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<form action="" method="post" class="form">
							...
							<div class="form-group col-md-6">
								...
								<select class="form-control" name="blog_category_slug">
									...
									<option value="<?=$row['blog_category_slug']?>"><?=$row['blog_category_title']?></option>
									<?php } ?>
								</select>
							</div>
							<div class="form-group col-md-6">
								<label>Time Stamp</label>
								<input type="text" class="form-control datepicker" name="date" value="<?=set_value('date')?>">
							</div>
							<div class="form-group col-md-12">
								<label>Blog Title</label>
								<input type="text" class="form-control maxlength" name="blog_title" value="<?=set_value('blog_title')?>" maxlength="60">
							</div>
							
							<div class="form-group col-md-12">
								<label>Blog Slug (Recommended non to change later)</label>
								<input type="text" class="form-control maxlength" name="blog_slug" value="<?=set_value('blog_slug')?>" maxlength="60">
							</div>
							...
							<div class="col-md-12" style="padding: 15px;margin: 10px auto;background-color:#ececec;border-radius:1px;">
								...
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control maxlength" name="blog_seo_title" value="<?=set_value('blog_seo_title')?>" maxlength="60">
								</div>
								<div class="form-group col-md-12">
									<label>Blog SEO Keywords</label>
									<input type="text" class="form-control maxlength" name="blog_seo_keywords" value="<?=set_value('blog_seo_keywords')?>" maxlength="60">
								</div>
								<div class="form-group col-md-12">
									<label>Blog SEO Description</label>
									<textarea class="form-control maxlength" name="blog_seo_description" maxlength="160"><?=set_value('blog_seo_description')?></textarea>
								</div>
							...
							<div class="form-group col-md-12">
								...
								<textarea class="editor" name="blog_content" rows="30"><?=set_value('blog_content')?></textarea>
							</div>
							<div class="form-group col-md-6">
								<label>Active</label>
							...
							<div class="form-group col-md-12">
								<label>Tags</label>
								<textarea class="tag_editor" name="tags"><?=set_value('tags')?></textarea>
							</div>
