      ...
      <div class="row">
          ...
          <div class="col-md-6" style="margin-top: 30px;">
              <div class="panel panel-primary">
                  ...
                  <h4><a href="<?=base_url()?>admin/login" data-toggle="tooltip" data-placement="bottom" title="Back To Login"><i class="fa fa-arrow-left"></i></a> &nbsp;&nbsp;&nbsp;Forgot Password</h4>
                  </div>
                  <div class="panel-body">
                      ...
                      <form method="post" action="">
                          <div class="form-group">
                              <label>Enter you email address here</label>
                              <input type="text" name="email_address" class="form-control">
                          </div>
                          <div class="form-group">
                              <input type="submit" class="btn btn-block btn-primary" value="Send Password Change Request">
                          </div>
                      </form>
                  </div>
              </div>
