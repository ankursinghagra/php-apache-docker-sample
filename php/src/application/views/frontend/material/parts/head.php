...
<html lang="en">
  <head>
    ...
    <!-- StyleSheets -->
    <link rel="stylesheet" href="<?=base_url()?>assets/front/material/css/bootstrap.min.css" media="screen">
    <link rel="stylesheet" href="<?=base_url()?>assets/front/material/css/material-kit.css" media="screen">

    <!-- Fonts and icons -->
    <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Roboto+Slab:400,700|Material+Icons" />
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" >
    <link rel="stylesheet" href="<?=base_url()?>assets/front/material/css/style.css">
  ...
  <?php if ( (isset($page_slug)) && (in_array($page_slug, array('home')) )) {?>
  <body >
  <?php }elseif( (isset($page_slug)) && (in_array($page_slug, array('about-us')) ) ){ ?>
  <body class="about-us">
  <?php }else{ ?>
  <body class="about-us">
  <?php  } ?>
    ...
    <div class="navbar navbar-primary navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <?php if($site_options['logo_or_text']=='LOGO'){echo '<img id="logo" class="img-responsive" src="'.base_url().'uploads/logo/'.$site_options['logo_file'].'" alt="'.$site_options['site_name'].'">';}else{echo $site_options['site_name'];}?>
          </a>
