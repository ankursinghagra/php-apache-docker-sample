...
<footer class="footer footer-black footer-big">
    ...
    <script src="<?=base_url()?>assets/front/material/js/bootstrap.min.js"></script>
    <script src="<?=base_url()?>assets/front/material/js/material.min.js"></script>
    <script src="<?=base_url()?>assets/front/material/js/material-kit.js"></script>
