<div class="page-header header-filter" data-parallax="active" style="background-image: url('<?=base_url()?>uploads/blog/<?=$blog['blog_photo']?>');">
	<div class="container">
		<div class="row">
						...
						<div class="row">
							<div class="col-md-2">
								<div class="card-avatar">
									<a href="#pablo">
										<img class="img" src="<?=base_url()?>uploads/admins/<?=$blog_author['photo']?>">
									</a>
		...
		<div class="section">
			<div class="row">
				<div class="col-md-8 col-md-offset-2"><br><br>
					<h4 class="title">Recent Articles</h4><br><br>
					<?php 
					...
					<?php 
		                ...
		                <div class="col-md-6">
							<div class="card card-raised tiny-blog">
								<div class="col-md-4">
									<img src="<?=base_url()?>uploads/blog/<?=thumb_str($blog['blog_photo'])?>">
								</div>
								<div class="col-md-8">
